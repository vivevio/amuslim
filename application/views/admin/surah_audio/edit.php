  ...
  <div class="row">
    <div class="col-md-6">
      <div class="box box-primary">
        ...
        <!-- form start -->
        <?php echo form_open_multipart('admin/surah_audio/save_changes/old-data', array('id'=>'surah','role'=>'form')); ?>
          <div class="box-body">
            <div class="form-group">
              <label for="2">Surah name</label>
              <input type="hidden" name="id" value="<?php echo $post->ayat_audio_id ?>">
